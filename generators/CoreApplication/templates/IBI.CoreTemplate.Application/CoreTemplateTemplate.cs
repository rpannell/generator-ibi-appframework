...
namespace IBI.<%= Name %>.Application
{
    ...
    public class <%= Name %>Template
    {
        ...
        /// the path must include the path through the areas for ExternalCorePluginTemplate
        /// </summary>
        public const string LAYOUTPATH = "~/Areas/ExternalCorePluginTemplate/Views/Shared/_Layout.cshtml";
        ...
        /// </summary>
        public const string PLUGINROLES = "Admin,Basic";
