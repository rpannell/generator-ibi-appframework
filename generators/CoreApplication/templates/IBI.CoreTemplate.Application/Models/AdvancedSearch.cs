...
namespace IBI.<%= Name %>.Application.Models
{
    public class AdvancedSearch
    {
        ...
        public enum AdvancedSearchType { Between = 0, NotEqual = 1, Equal = 2, LessThan = 3, LessThanEqual = 4, GreaterThan = 5, GreaterThanEqual = 6, Like = 7, In = 8, IsNull = 9, IsNotNull = 10, NotLike = 11, NotIn = 12 };
        ...
        /// <summary>
        /// Creates an "NOT IN clause IN(a,b,c....,etc)" filter
        /// </summary>
        /// <param name="propertyName">The name of the entity property to query</param>
        /// <param name="a">The value to filter</param>
        /// <returns>AdvancedSearch</returns>
        public static AdvancedSearch NotIn(string propertyName, List<object> a)
        {
            return new AdvancedSearch(propertyName, AdvancedSearchType.NotIn, a);
        }

        /// <summary>
        /// Creates a "NOT LIKE (%a%)" filter
        /// </summary>
        /// <param name="propertyName">The name of the entity property to query</param>
        /// <param name="a">The value to filter</param>
        /// <returns>AdvancedSearch</returns>
        public static AdvancedSearch NotLike(string propertyName, object a)
        {
            return new AdvancedSearch(propertyName, AdvancedSearchType.NotLike, a, null);
        }
