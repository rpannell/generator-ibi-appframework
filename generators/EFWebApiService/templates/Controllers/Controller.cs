...
namespace IBI.<%= projectname %>.Service.Controllers
{
    ...
    public partial class <%= entityinfo.PropertyName %>Controller : BaseController<I<%= entityinfo.PropertyName %>Service, I<%= entityinfo.PropertyName %>Repository, <%= entityinfo.PropertyName %>, <%= entityinfo.PrimaryKey %>>
    {
        ...
        public override PaginationResult<<%= entityinfo.PropertyName %>> AdvancedPage(int id, [FromBody] AdvancedPageModel model)
        {
        ...
        [HttpDelete(), Route("{id}")]
        public override <%= entityinfo.PropertyName %> Delete(<%= entityinfo.PrimaryKey %> id)
        {
        ...
        public override List<<%= entityinfo.PropertyName %>> GetAutoComplete(int id, [FromBody] AutoComplete model)
        {
        ...
        public override PaginationResult<<%= entityinfo.PropertyName %>> GetPage(int limit, int offset, string search = null, string sort = null, string sortOrder = "desc")
        {
        ...
        [HttpPost(), Route("")]
        public override <%= entityinfo.PropertyName %> Post([FromBody] <%= entityinfo.PropertyName %> entity)
        {
        ...
        [HttpPut(), Route("{id}")]
        public override <%= entityinfo.PropertyName %> Put(int id, [FromBody] <%= entityinfo.PropertyName %> entity)
        {
