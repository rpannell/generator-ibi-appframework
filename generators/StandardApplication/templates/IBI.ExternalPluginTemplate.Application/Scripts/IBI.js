...
var IBI = (function () {
    ...
    modalString += "<div class=\"modal fade\" data-backdrop=\"static\" data-keyboard=\"false\"><div class=\"processing-modal modal-content\">";
    modalString += "<div class=\"modal-header text-center\"><h4 class=\"modal-title\">|TITLE|</h4></div>";
    modalString += "<div class=\"modal-body\"><div class=\"row v-center\"><div class=\"col-xs-2 col-md-offset-4 text-center\"><label class=\"fa fa-spinner fa-spin fa-5x \"></label></div></div></div>";
    modalString += "</div></div>";

    errorString += "<div class=\"modal fade\"><div class=\"modal-dialog\"><div class=\"modal-content\">";
    ...
    infoString += "<div class=\"modal fade\"><div class=\"modal-dialog\"><div class=\"modal-content\">";
    ...
    return {
        ...
        TokenField: {
            GetTokens: function (id) {
                /// <summary>
                /// Returns a JSON with the data from a tokenfield
                /// </summary>
                /// <param name="id">The id of the tokenfield with or without the starting #</param>
                var correctId = IBI.UI.GetJqueryId(id);
                return $(correctId).tokenfield('getTokens');
            },
            GetActiveToken: function (id) {
                /// <summary>
                /// Returns a JSON with the data from a tokenfield
                /// </summary>
                /// <param name="id">The id of the tokenfield with or without the starting #</param>
                var correctId = IBI.UI.GetJqueryId(id);
                return $(correctId).tokenfield('getTokens', true);
            },
            SetDataTo: function (id, data) {
                /// <summary>
                /// Manually set the tokenfield content (replacing the old content)
                /// </summary>
                /// <param name="id" type="type">The id of the tokenfield with or without the starting #</param>
                /// <param name="data" type="type">The data to replace to the tokenfield</param>
                $(IBI.UI.GetJqueryId(id)).tokenfield('setTokens', data);
            },
            DisableToken: function (id) {
                ...
                /// </summary>
                /// <param name="id" type="type">The id of the tokenfield with or without the starting #</param>
                $(IBI.UI.GetJqueryId(id)).tokenfield('disable');
            },
            EnableToken: function (id) {
                /// <summary>
                /// Enable tokenfield (just like a normal input field)
                // </summary>
                /// <param name="id" type="type">The id of the tokenfield with or without the starting #</param>
                $(IBI.UI.GetJqueryId(id)).tokenfield('enable');
            },
            ReadonlyToken: function (id, data) {
                /// <summary>
                /// Make tokenfield a readonly field (just like a normal input field)
                /// </summary>
                /// <param name="id" type="type">The id of the tokenfield with or without the starting #</param>
                $(IBI.UI.GetJqueryId(id)).tokenfield('readonly');
            },

            WriteableToken: function (id, data) {
                /// <summary>
                /// Make tokenfield writeable (just like a normal input field)
                /// </summary>
                /// <param name="id" type="type">The id of the tokenfield with or without the starting #</param>
                $(IBI.UI.GetJqueryId(id)).tokenfield('writeable');
            },
        },
        UI: {
            ...
            PushOrder: function (id, callnumber, link) {
                /// <summary>
                /// Will append data to a bootstrap table
                /// </summary>
                /// <param name="id" type="type">The id of the table with or without the starting #</param>
                /// <param name="data" type="type">The data to append to the table</param>
                $(IBI.UI.GetJqueryId(id)).append('<li  class="orderQuickFilter"><a href="' + link + '"><span>' + callnumber + '</span></a></li>');
            },
        ...
        Storage: {
            GetKeyName: function (area, name) {
                ...
                /// <param name="name" type="string">The name of the key</param>
                /// <returns type=""></returns>
            ...
            SetSessionData: function (area, keyname, objectData) {
                ...
                /// <param name="objectData" type="object">The object to add to the session storage</param>
            ...
            GetSessionData: function (area, keyname) {
                ...
                /// <param name="area" type="string">The name of the area</param>
                /// <param name="keyname" type="string">The name of the key</param>
                /// <returns type="object">The object from storage</returns>
